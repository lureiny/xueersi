...
class App:
    ...
    def init_window(self):
        ...
        tk.Button(frame3, text="发送", command=self.button, height=1, width=10).pack(side=tk.LEFT, expand=1)
        tk.Button(frame3, text="自动发送", command=self.button, height=1, width=10).pack(side=tk.LEFT, expand=1)
